...
}$(document).click(function(c){if(!$(c.target).parents().andSelf().is(".social-share-rebrand")){if($(".social-share-rebrand-overlay").hasClass("active")){$(".social-share-rebrand-overlay").removeClass("active");
